                ...
                layer_def = src.substitute(
                    {
                        ...
                        "expanded_radius": int(float(node.config["radius"])) * 2,
                        "haloRadius": node.config["haloRadius"],
                        "expanded_haloRadius": int(float(node.config["haloRadius"]))
                        * 2,
                        ...
                        "expanded_weight": int(float(node.config["weight"])) * 2,
                        "expanded_haloWeight": int(float(node.config["haloWeight"]))
                        * 2,
                        "fillColor": node.config["fillColor"],
                        "outlineColor": node.config["outlineColor"],
                        "outlineWeight": node.config["outlineWeight"],
                        "expanded_outlineWeight": int(
                            float(node.config["outlineWeight"])
                        )
                        * 2,
                    }
                )
