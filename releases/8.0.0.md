...
- The `TileModel.nodegroup` foreign key constraint is no longer enforced, since it can now store UUIDs referring to historical nodegroups that no longer exist. It is also now nullable.
